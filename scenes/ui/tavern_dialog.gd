...
func _refresh() -> void:
	...
	header.add_theme_font_size_override("font_size", 48 if _is_mobile else 18)
	...
	desc.add_theme_font_size_override("font_size", 34 if _is_mobile else 12)
	...
	if _player:
		...
		if not active.is_empty():
			...
			active_label.add_theme_font_size_override("font_size", 34 if _is_mobile else 12)
	...
	cost_info.add_theme_font_size_override("font_size", 40 if _is_mobile else 14)
	...
	odds.add_theme_font_size_override("font_size", 30 if _is_mobile else 10)
